...
describe("schemas", () => {
  describe("AddressSchema", () => {
    it("validates correct addresses", () => {
      const result = AddressSchema.safeParse("0x742d35Cc6634C0532925a3b844Bc9e7595f6E123")
    ...
    it("rejects invalid addresses", () => {
      ...
      expect(AddressSchema.safeParse("0x742d35Cc6634C0532925a3b844Bc9e7595f6E12").success).toBe(
        false,
      ) // Too short
    })
  })
  ...
  describe("ConnectWalletArgsSchema", () => {
    ...
    it("rejects invalid args", () => {
      ...
      expect(ConnectWalletArgsSchema.safeParse({ address: "invalid" }).success).toBe(false)
    })
  })

  describe("SignMessageArgsSchema", () => {
    it("validates sign message args", () => {
      expect(SignMessageArgsSchema.safeParse({ message: "Hello world" }).success).toBe(true)
    })
  ...
  describe("SwitchChainArgsSchema", () => {
    it("validates chain ID", () => {
      expect(SwitchChainArgsSchema.safeParse({ chainId: 1 }).success).toBe(true)
      expect(SwitchChainArgsSchema.safeParse({ chainId: 137 }).success).toBe(true)
    })
  ...
  describe("AddCustomChainArgsSchema", () => {
    ...
    it("validates custom chain args", () => {
      expect(AddCustomChainArgsSchema.safeParse(validChainArgs).success).toBe(true)
    })
  ...
  describe("SetWalletTypeArgsSchema", () => {
    it("validates wallet types", () => {
      expect(SetWalletTypeArgsSchema.safeParse({ type: "mock" }).success).toBe(true)
      expect(SetWalletTypeArgsSchema.safeParse({ type: "privateKey" }).success).toBe(true)
    })

    it("rejects invalid types", () => {
      expect(SetWalletTypeArgsSchema.safeParse({ type: "invalid" }).success).toBe(false)
    })
  })
