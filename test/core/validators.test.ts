...
describe("validators", () => {
  describe("isValidAddress", () => {
    it("validates correct Ethereum addresses", () => {
      expect(isValidAddress("0x742d35Cc6634C0532925a3b844Bc9e7595f6E123")).toBe(true)
    ...
    it("rejects invalid addresses", () => {
      ...
      expect(isValidAddress("0xGGGGd35Cc6634C0532925a3b844Bc9e7595f6E123")).toBe(false)
    })
  })
  ...
  describe("isValidPrivateKey", () => {
    ...
    it("rejects invalid private keys", () => {
      ...
      // Wrong length
      expect(isValidPrivateKey("0xac0974bec39a17e36ba4a6b4d238ff944")).toBe(false)
    })
  })
  ...
  describe("addressExists", () => {
    ...
    it("finds addresses case-insensitively", () => {
      expect(addressExists("0x742d35Cc6634C0532925a3b844Bc9e7595f6E123", addresses)).toBe(true)
      expect(addressExists("0x742D35CC6634C0532925A3B844BC9E7595F6E123", addresses)).toBe(true)
      expect(addressExists("0x742d35cc6634c0532925a3b844bc9e7595f6e123", addresses)).toBe(true)
    })

    it("returns false for non-existent addresses", () => {
      expect(addressExists("0x0000000000000000000000000000000000000000", addresses)).toBe(false)
    })
  })
