...
describe("formatters", () => {
  ...
  describe("shortenAddress", () => {
    it("shortens addresses correctly", () => {
      expect(shortenAddress("0x742d35Cc6634C0532925a3b844Bc9e7595f6E123")).toBe("0x742d...E123")
      expect(shortenAddress("0x742d35Cc6634C0532925a3b844Bc9e7595f6E123", 6)).toBe(
        "0x742d35...f6E123",
      )
    })
