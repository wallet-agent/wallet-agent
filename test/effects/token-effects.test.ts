...
import type { ContractReadParams, ContractWriteParams } from "../../src/contract-operations"
...
describe("TokenEffects", () => {
  ...
  beforeEach(() => {
    ...
    mockWriteContract = mock(
      async () => "0x1234567890123456789012345678901234567890123456789012345678901234" as Hex,
    )
  ...
  describe("ERC-20 Operations", () => {
    describe("transferToken", () => {
      it("transfers tokens successfully", async () => {
        ...
        expect(hash).toBe("0x1234567890123456789012345678901234567890123456789012345678901234")
    ...
    describe("getTokenBalance", () => {
      ...
      it("gets token balance for specific address", async () => {
        const specificAddress = "0x70997970C51812dc3A010C7d01b50e0d17dc79C8" as Address
  ...
  describe("ERC-721 Operations", () => {
    describe("transferNFT", () => {
      ...
      it("throws error when wallet not connected", async () => {
        ...
        expect(disconnectedTokenEffects.transferNFT(params)).rejects.toThrow("No wallet connected")
      })
    })
  ...
  describe("Contract Resolution", () => {
    ...
    it("handles raw addresses", async () => {
      const randomAddress = "0x1111111111111111111111111111111111111111" as Address
      await tokenEffects.getTokenBalance({
        token: randomAddress,
      })
