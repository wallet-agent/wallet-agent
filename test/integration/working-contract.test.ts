...
describe.skipIf(!useRealAnvil)("Working Contract Deployment Tests", () => {
  ...
  beforeAll(async () => {
    console.log(
      "Using real Anvil blockchain for contract deployment testing...",
    );
  ...
  describe("Storage Contract - Real Deployment Tests", () => {
    ...
    it("should store and retrieve a value", async () => {
      ...
      console.log(
        `✓ Successfully stored and retrieved value: ${retrievedValue}`,
      );
    });
    ...
    it("should demonstrate real contract state persistence", async () => {
      ...
      console.log(
        `✓ State persistence verified: ${initialValue} → ${newValue}`,
      );
    });
  });
