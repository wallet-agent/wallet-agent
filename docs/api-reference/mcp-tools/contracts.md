...
Contract tools enable AI assistants to interact with smart contracts through natural language prompts. These tools handle contract loading, reading contract state, and executing contract functions.
