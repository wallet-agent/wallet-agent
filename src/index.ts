...
import { createConfig, connect, disconnect, getAccount, signMessage, signTypedData, sendTransaction, switchChain, getBalance } from '@wagmi/core';
import { mock } from '@wagmi/connectors';
import { mainnet, sepolia, polygon } from 'viem/chains';
import { http, createPublicClient, createWalletClient, formatEther, parseEther, type Address } from 'viem';
      ...
      },
      {
        ...
        inputSchema: {
          ...
          properties: {
            chainId: {
              type: "number",
              description: "Chain ID to switch to (1 for mainnet, 11155111 for sepolia, 137 for polygon)",
            },
          },
          required: ["chainId"],
        },
